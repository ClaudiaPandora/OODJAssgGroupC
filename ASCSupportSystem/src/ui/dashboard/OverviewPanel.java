...
public class OverviewPanel extends BasePanel {
    ...
    private JPanel createHeaderPanel() {
        ...
        liveLabel.setBorder(BorderFactory.createEmptyBorder(3, 8, 3, 8));
    ...
    private JPanel createActivitiesPanel() {
        ...
        for (int i = appointments.size() - 1; i >= 0 && count < 6; i--, count++) {
            ...
            item.setBorder(BorderFactory.createEmptyBorder(4, 15, 4, 15));
    ...
    private JPanel createRightPanel() {
        ...
        for (int i = 0; i < techs.size(); i++) {
            ...
            JLabel idLabel = new JLabel("ID: " + tech.getId());
    ...
    private JPanel createAvatar(String fullName) {
        ...
        avatarPanel.setMinimumSize(new Dimension(32, 32));
        avatarPanel.setMaximumSize(new Dimension(32, 32));
    ...
    private JPanel createFeedbackPanel() {
        ...
        feedbackPanel.setMaximumSize(new Dimension(Integer.MAX_VALUE, 180));
        feedbackPanel.setPreferredSize(new Dimension(0, 180));
        ...
        JLabel title = new JLabel("Customer Feedback Highlights");
        title.setFont(new Font("Segoe UI", Font.BOLD, 13));
        title.setForeground(NAVY_BLUE);
        header.add(title, BorderLayout.WEST);

        feedbackPanel.add(header);

        // Divider
        JSeparator sep = new JSeparator();
        sep.setForeground(new Color(220, 220, 220));
        sep.setMaximumSize(new Dimension(Integer.MAX_VALUE, 1));
        feedbackPanel.add(sep);
        ...
        if (feedbacks.isEmpty()) {
            JLabel emptyLabel = new JLabel("No feedback available yet");
            ...
            feedbackPanel.add(content);
            return feedbackPanel;
        }

        // Get latest feedback only
        Feedback latest = feedbacks.get(feedbacks.size() - 1);
        User technician = userDAO.findById(latest.getTechnicianId());
        String techName = technician != null ? technician.getFullName() : "Technician";

        // Rating display as text centered
        JPanel ratingPanel = new JPanel(new FlowLayout(FlowLayout.CENTER, 0, 0));
        ratingPanel.setBackground(Color.WHITE);
        ratingPanel.setAlignmentX(Component.CENTER_ALIGNMENT);
        
        JLabel ratingLabel = new JLabel(latest.getRating() + "/5");
        ratingLabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
        ratingLabel.setForeground(NAVY_BLUE);
        ...
        if (commentText.length() > 45) {
            commentText = commentText.substring(0, 42) + "...";
        }
        ...
        JLabel techLabel = new JLabel("- " + techName);
        techLabel.setFont(new Font("Segoe UI", Font.PLAIN, 10));
        techLabel.setForeground(new Color(120, 120, 120));
        techLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
        content.add(techLabel);
